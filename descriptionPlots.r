...
descriptionPlots <- function(counts, n=3, group=target[,varInt], OutDir, col){
  ...
  source("/Users/upendrakumardevisetty/Documents/git_repos/edgeR_multifactorial/barplotNull.R")

  # percentage of null counts per sample
  barplotNull(counts, group=target[,varInt], OutDir, col)
  
  source("/Users/upendrakumardevisetty/Documents/git_repos/edgeR_multifactorial/densityPlot.R")

  # distribution of counts per sample
  densityPlot(counts, group=target[,varInt], OutDir, col)
  
  source("/Users/upendrakumardevisetty/Documents/git_repos/edgeR_multifactorial/majSequences.R")
  ...
  source("/Users/upendrakumardevisetty/Documents/git_repos/edgeR_multifactorial/pairwiseScatterPlots.R")
