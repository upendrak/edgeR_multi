...
```{r , cache=TRUE, echo=FALSE, results="asis"}
print(majSequences,caption="Table 4: Percentage of reads associated with the sequences having the highest counts.", type="html", html.table.attributes = "align='center'")
```
...
<figure>
<center>
    <img src="pairwiseScatter.png" alt="Pairwise scatter plot" width="60%" />
