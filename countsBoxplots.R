...
countsBoxplots <- function(object, group=target[,varInt], col, OutDir){
  ...
  png(filename=paste(nd,"countsBoxplots.png",sep="/"),width=2*min(2200,1800+800*ncol(norm.counts)/10),height=1800,res=300)
  par(mfrow=c(1,2))
